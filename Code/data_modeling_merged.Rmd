...
# Create a linear model using all attributes
...
```
Let’s create a linear model using the most important attributes relevant to revenue; Loc_Other, vendor_category_id, vendor_rating, preparationtime, temp.

```{r}

# Create a linear model using the most important attributes
lm_revenue.final = lm(revenue~Loc_Other+vendor_category_id+vendor_rating+preparationtime+temp, data=df.merged)
